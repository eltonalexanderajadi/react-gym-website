...
const Header = () => {
  ...
  return (
    ...
    {menuOpened === false && mobile === true ? (
      <div style={{cursor: 'pointer', backgroundColor: 'var(--caloryCard)', padding: "0.5rem", borderRadius: "5px" }}
      ...
      <ul className='header-menu'>
        <div onClick={()=> setMenuOpened(false)}> <img src={Close} alt="" style={{cursor: 'pointer', width: '1.5rem', height: '1.5rem'}} /> </div>
